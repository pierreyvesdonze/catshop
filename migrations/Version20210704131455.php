 ...
 */
final class Version20210704131455 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_23A0E66B6A1BD45 FOREIGN KEY (cart_line_id) REFERENCES cart_line (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
